...
/**
 * Opt-In Page - Twilio Toll-Free Verification
 * 
 ...
 * 
 * URL: https://c3one.com/helpdesk/opt-in
 */
...
export default function OptInPage() {
  ...
  return (
    <>
      <Head>
        <title>Consentimento para Mensagens SMS/Texto (Text Messaging) - C³ One</title>
        <meta
          name="description"
      ...
      <section className={styles.hero} style={{ minHeight: "auto", padding: "60px 20px" }}>
        <div className={styles.heroContent} style={{ maxWidth: "900px" }}>
          <h1 style={{ marginBottom: "20px" }}>
            Consentimento para Mensagens SMS/Texto (Text Messaging)
          </h1>
          <p style={{ fontSize: "1.1rem", marginBottom: "10px" }}>
            C³ One - Sistema de Gestão
          </p>
          <p style={{ fontSize: "0.9rem", color: "var(--logo-gray)" }}>
            Informações explícitas sobre recebimento de mensagens de texto (SMS) do sistema de atendimento
          </p>
        </div>
      </section>
      ...
      <section className={styles.about} style={{ maxWidth: "900px", margin: "0 auto", padding: "40px 20px" }}>
        {!submitted ? (
          <form onSubmit={handleSubmit}>
            ...
            <div style={{
              ...
              <h2 style={{
                ...
                ✓ Informações sobre recebimento de mensagens de texto (SMS) do sistema de atendimento
              </h2>
              ...
              <h3 style={{
                ...
                ✓ O que você receberá via SMS/Texto:
              </h3>
              ...
              <ul style={{ listStyle: "none", padding: 0, lineHeight: "2" }}>
                <li style={{ marginBottom: "12px", paddingLeft: "25px", position: "relative" }}>
                  ...
                  <strong>Confirmações de agendamentos e consultas</strong> - Mensagens SMS confirmando seus agendamentos
                </li>
                <li style={{ marginBottom: "12px", paddingLeft: "25px", position: "relative" }}>
                  <span style={{ position: "absolute", left: 0, color: "var(--logo-blue)", fontSize: "1.2rem", fontWeight: "bold" }}>•</span>
                  <strong>Lembretes de compromissos</strong> - Mensagens SMS lembrando você de seus compromissos
                </li>
                <li style={{ marginBottom: "12px", paddingLeft: "25px", position: "relative" }}>
                  <span style={{ position: "absolute", left: 0, color: "var(--logo-blue)", fontSize: "1.2rem", fontWeight: "bold" }}>•</span>
                  <strong>Notificações de status de tickets de suporte</strong> - Mensagens SMS sobre atualizações de seus tickets
                </li>
                <li style={{ marginBottom: "12px", paddingLeft: "25px", position: "relative" }}>
                  <span style={{ position: "absolute", left: 0, color: "var(--logo-blue)", fontSize: "1.2rem", fontWeight: "bold" }}>•</span>
                  <strong>Respostas automáticas do atendimento ao cliente</strong> - Mensagens SMS com respostas do sistema de atendimento
                </li>
                <li style={{ marginBottom: "12px", paddingLeft: "25px", position: "relative" }}>
                  <span style={{ position: "absolute", left: 0, color: "var(--logo-blue)", fontSize: "1.2rem", fontWeight: "bold" }}>•</span>
                  <strong>Atualizações sobre pedidos e serviços</strong> - Mensagens SMS sobre status de pedidos e serviços
                </li>
              </ul>
            </div>
            ...
            <div style={{
              ...
              <h2 style={{
                ...
                🔒 Como funciona o consentimento para mensagens SMS/Texto
              </h2>
              ...
              <div style={{ lineHeight: "1.8" }}>
                <div style={{
                  ...
                  <p style={{ marginBottom: "10px", fontWeight: "bold", fontSize: "1.1rem" }}>
                    <strong>Opt-In (Consentimento Explícito):</strong>
                  </p>
                  <p style={{ marginBottom: "10px" }}>
                    Ao fornecer seu número de telefone durante o cadastro ou atendimento e marcar a caixa de consentimento abaixo, <strong style={{ color: "var(--logo-blue)" }}>você explicitamente concorda em receber mensagens de texto (SMS/text messaging)</strong> da C3ONE relacionadas ao seu atendimento e serviços.
                  </p>
                  <p style={{ fontSize: "0.9rem", color: "#666", fontStyle: "italic", borderTop: "1px solid #e0e0e0", paddingTop: "10px", marginTop: "10px" }}>
                    <strong>Importante:</strong> Este consentimento é específico para mensagens de texto (SMS) e é separado de outros acordos, como Política de Privacidade ou Termos de Serviço.
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ marginBottom: "10px", fontWeight: "bold", fontSize: "1.1rem" }}>
                    <strong>Opt-Out (Cancelamento):</strong>
                  </p>
                  <p>
                    Você pode cancelar o recebimento de mensagens SMS a qualquer momento respondendo <strong style={{ color: "#d32f2f", fontSize: "1.1rem" }}>STOP</strong> para qualquer mensagem. O cancelamento é imediato e gratuito.
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p>
                    Para obter ajuda, responda <strong style={{ color: "var(--logo-blue)", fontSize: "1.1rem" }}>HELP</strong> para qualquer mensagem SMS.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div style={{
              ...
              <h2 style={{
                ...
                💰 Taxas e Informações sobre Mensagens SMS
              </h2>

              <div style={{ lineHeight: "1.8" }}>
                <p style={{ marginBottom: "10px" }}>
                  <strong>Taxas de mensagem podem aplicar</strong> conforme seu plano de telefonia. A C3ONE não cobra taxas adicionais pelas mensagens SMS.
                </p>
                <p style={{ marginBottom: "10px" }}>
                  As mensagens SMS são enviadas apenas para fins de suporte ao cliente e gestão de relacionamento. <strong>Não enviamos mensagens promocionais ou de marketing através deste serviço.</strong>
                </p>
                <p style={{ fontWeight: "bold", color: "#333" }}>
                  Frequência: Mensagens enviadas apenas quando necessário (confirmações, lembretes, atualizações de status).
                </p>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  ✓ Ao fornecer seu número de telefone e confirmar, você concorda em receber mensagens SMS/text messaging conforme descrito acima.
                </p>
                ...
                <div style={{
                  ...
                  <p style={{
                    ...
                    EU CONCORDO EM RECEBER MENSAGENS DE TEXTO (SMS) DA C3ONE
                  </p>
                  <p style={{ lineHeight: "1.8" }}>
                    Ao marcar a caixa de consentimento abaixo e fornecer meu número de telefone, <strong style={{ color: "var(--logo-blue)" }}>eu explicitamente concordo e autorizo a C3ONE a enviar mensagens de texto (SMS/text messaging)</strong> para o número fornecido.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div style={{
                ...
                <div style={{ display: "flex", alignItems: "flex-start", gap: "15px" }}>
                  ...
                  <label htmlFor="sms-consent-explicit" style={{ flex: 1 }}>
                    ...
                    <ul style={{
                      ...
                      <li><strong>Concordo explicitamente</strong> em receber mensagens de texto (SMS/text messaging) da C3ONE</li>
                    ...
                    <p style={{
                      ...
                      Este consentimento é obrigatório para receber mensagens SMS da C3ONE e está em conformidade com as leis federais dos EUA (TCPA - Telephone Consumer Protection Act).
                    </p>
                  </label>
                </div>
              </div>
              ...
              <div style={{
                ...
                <p><strong>Empresa:</strong> C3ONE LLC</p>
          ...
          <div style={{ textAlign: "center", padding: "40px" }}>
            ...
            <p style={{ fontSize: "1.1rem", color: "#666", marginBottom: "10px" }}>
              ...
              Você receberá mensagens de texto da C3ONE conforme descrito acima.
            </p>
        ...
        <div style={{
          ...
          <Link href="/helpdesk" style={{ color: "var(--logo-blue)", textDecoration: "underline" }}>
            Suporte
          </Link>
        </div>
        ...
        <div style={{
          ...
          <p style={{ marginTop: "20px" }}>Última atualização: 05/12/2025</p>
